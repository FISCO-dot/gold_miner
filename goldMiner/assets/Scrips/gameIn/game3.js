...
cc.Class({
    ...
    onLoad:function() {
        ...
        this.pigAssem.destroyAllChildren();
    ...
    spawnNewPigs: function(){
        for(var i =0;i<2;i++){
            var newPig = cc.instantiate(this.pigPrefab);
            newPig.getComponent('pig').game = this;
            do{
                var pick = true ;
                var pos = this.getPosition();
                if(this.itemList.length == 0) break;
            ...
            newPig.setPosition(pos);
            this.itemList.push(pos);
            this.itemNodeList.push(newPig);
            this.pigAssem.addChild(newPig);
        }
    },
